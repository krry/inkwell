...
>
	<a
		href="/ritual?step=1"
		class="quadrant-card card card-hover variant-glass-warning hover:border-warning-500 dark:hover:border-warning-400"
	>
	...
	<a
		href="/ritual?step=2"
		class="quadrant-card card card-hover variant-glass-surface hover:border-surface-500 hover:dark:border-surface-400"
	>
	...
	<a
		href="/ritual?step=3"
		class="quadrant-card card card-hover variant-glass-success hover:border-success-500 hover:dark:border-success-400"
	>
	...
	<a
		href="/ritual?step=4"
		class="quadrant-card card card-hover variant-glass-error hover:border-error-500 hover:dark:border-error-400"
	>
