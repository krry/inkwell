...
>
	...
	<a
		class="block card card-hover md:absolute bg-primary-300-500-token z-1 opacity-75 hover:z-10 hover:opacity-100 inset-0 m-auto rounded-full h-64 w-64 flex flex-col justify-center items-center border-2 border-secondary-200 dark:border-secondary-700 transition-opacity duration-300 ease-in-out reveal-link-on-focus"
		href="/inkwell-template-2023.png"
		download
	>
		<InkBottle size={64} classes={'text-secondary-400 -mt-16'} />
		<h1 class="gradient-heading font-bold">Ink Well</h1>
		<div
			class="hidden-link mt-4 absolute bottom-8 inset-x-0 mx-auto bg-transparent opacity-0 transition-opacity duration-300 ease-in-out flex flex-col justify-center items-center"
		>
			<p class="text-sm px-12">
				<span>Get the template</span>
			</p>
			<div class="badge-icon text-2xl">
				<svg
